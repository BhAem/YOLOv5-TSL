...
# aug2 = iaa.Rain(drop_size=0.01, speed=0.03)
...
def load_image(self, i):
    ...
    if im is None:  # not cached in ram
        ...
        if npy and npy.exists():  # load npy
            ...
            #     b = path.split("/")
            #     b[-2] += 'fog'
            #     b[-1] = b[-1].split(".")[0] + "_fog" + ".jpg"
            #     path = "/" + os.path.join(*b).replace("\\", "/")
            # elif num_seed == 4:
            #     b = path.split("/")
            #     b[-2] += 'night'
            #     b[-1] = b[-1].split(".")[0] + "_night" + ".jpg"
            #     path = "/" + os.path.join(*b).replace("\\", "/")
            # num_seed += 1
            # num_seed %= 5
